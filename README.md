...
## Table Of Contents
  ...
  * [Features](#features)
    ...
    + [Other features](#other-features)
      - [GitHub experiences and user stats](#github-experiences-and-user-stats)
      - [Theming](#theming)
...
#### GitHub experiences and user stats
**al-folio** uses [github-readme-stats](https://github.com/anuraghazra/github-readme-stats) to display GitHub experiences and user stats on the the `/experiences/` page.

Edit the `_data/experiences.yml` and change the `github_users` and `github_repos` lists to include your own GitHub profile and experiences to the the `/experiences/` page.
